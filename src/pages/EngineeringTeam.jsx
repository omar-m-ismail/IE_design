...
Experience Level: 5+ years preferred (flexible based on potential)
    ...
    <br />
              ...
              <ul>
                ...
                <li>5+ years of professional experience preferred (flexible for candidates with strong leadership potential)</li>
                ...
                <li>A valid driver’s license and access to a personal vehicle for site visits</li>
              </ul>
              <br />
              ...
              <h3> To Apply
                ...
                <h3>By email (pdf files only) to <span className="underline">iedesign@iedesign.ca</span></h3>
    </div>
  </div>
...
Experience Level: 1+ years preferred 
          ...
          <ul>
            ...
            <li>Minimum experience of 2–3 years in structural engineering drawings</li>
            <li>Strong REVIT experience in structural engineering and relevant site experience</li>
          ...
          <h3>Key Responsibilities</h3>
          <ul>
            <li>Develop BIM and REVIT Models for Structural Projects</li>
